...
inline int ftmkconfig_usb (int tmkNumber, int wType, int PortsAddr1, int PortsAddr2){return -1;}
inline int ftmkdone_usb (int tmkNumber){return -1;}
inline int ftmkselect_usb(int tmkNumber){return -1;}
inline void ftmkdefevent_usb(void *hEvent){}
inline int fRead_DLL_EvD_usb(TListEvD *evd){return -1;}
inline void ftmksetcwbits_usb(TMK_DATA tmkSetControl){}
inline void ftmkclrcwbits_usb(TMK_DATA tmkClrControl){}
inline TMK_DATA ftmkgetcwbits_usb(){return -1;}
inline TMK_DATA ftmkgetmode_usb(){return -1;}
inline int ftmkdefdac_usb(int dacValue){return -1;}
inline int ftmkgetdac_usb(int *value, int *mode){return -1;}
inline int fbcreset_usb(){return -1;}
inline int fbcdefirqmode_usb(TMK_DATA bcIrqMode){return -1;}
inline TMK_DATA fbcgetirqmode_usb(){return -1;}
inline TMK_DATA fbcgetmaxbase_usb(){return -1;}
inline int fbcdefbase_usb(TMK_DATA bcBasePC){return -1;}
inline TMK_DATA fbcgetbase_usb(){return -1;}
inline void fbcputw_usb(TMK_DATA bcAddr, TMK_DATA bcData){}
inline TMK_DATA fbcgetw_usb(TMK_DATA bcAddr){return -1;}
inline DWORD fbcgetansw_usb(TMK_DATA bcCtrlCode){return -1;}
inline void fbcputblk_usb(TMK_DATA bcAddr, void *pcBuffer, TMK_DATA cwLength){}
inline void fbcgetblk_usb(TMK_DATA bcAddr, void *pcBuffer, TMK_DATA cwLength){}
inline int  fbcdefbus_usb(TMK_DATA bcBus){return -1;}
inline TMK_DATA fbcgetbus_usb(){return -1;}
inline int fbcstart_usb(TMK_DATA bcBase, TMK_DATA bcCtrlCode){return -1;}
inline int fbcstartx_usb(TMK_DATA bcBase, TMK_DATA bcCtrlCode){return -1;}
inline int fbcdeflink_usb(TMK_DATA bcBase, TMK_DATA bcCtrlCode){return -1;}
inline DWORD fbcgetlink_usb(){return -1;}
inline TMK_DATA fbcstop_usb(){return -1;}
inline DWORD fbcgetstate_usb(){return -1;}
inline int frtreset_usb(){return -1;}
inline int frtdefirqmode_usb(TMK_DATA rtIrqMode){return -1;}
inline TMK_DATA frtgetirqmode_usb(){return -1;}
inline int frtdefmode_usb(TMK_DATA rtMode){return -1;}
inline TMK_DATA frtgetmode_usb(){return -1;}
inline TMK_DATA frtgetmaxpage_usb(){return -1;}
inline int frtdefpage_usb(TMK_DATA rtPage){return -1;}
inline TMK_DATA frtgetpage_usb(){return -1;}
inline int frtdefpagepc_usb(TMK_DATA rtPagePC){return -1;}
inline int frtdefpagebus_usb(TMK_DATA rtPageBus){return -1;}
inline TMK_DATA frtgetpagepc_usb(){return -1;}
inline TMK_DATA frtgetpagebus_usb(){return -1;}
inline int frtdefaddress_usb(TMK_DATA rtAddress){return -1;}
inline TMK_DATA frtgetaddress_usb(){return -1;}
inline void frtdefsubaddr_usb(TMK_DATA rtDir, TMK_DATA rtSubAddr){}
inline TMK_DATA frtgetsubaddr_usb(){return -1;}
inline void frtputw_usb(TMK_DATA rtAddr, TMK_DATA rtData){}
inline TMK_DATA frtgetw_usb(TMK_DATA rtAddr){return -1;}
inline void frtputblk_usb(TMK_DATA rtAddr, void *pcBuffer, TMK_DATA cwLength){}
inline void frtgetblk_usb(TMK_DATA rtAddr, void *pcBuffer, TMK_DATA cwLength){}
inline void frtsetanswbits_usb(TMK_DATA rtSetControl){}
inline void frtclranswbits_usb(TMK_DATA rtClrControl){}
inline TMK_DATA frtgetanswbits_usb(){return -1;}
inline void frtgetflags_usb(void *pcBuffer, TMK_DATA rtDir, TMK_DATA rtFlagMin, TMK_DATA rtFlagMax){}
inline void frtputflags_usb(void *pcBuffer, TMK_DATA rtDir, TMK_DATA rtFlagMin, TMK_DATA rtFlagMax){}
inline void frtsetflag_usb(){}
inline void frtclrflag_usb(){}
inline TMK_DATA frtgetflag_usb(TMK_DATA rtDir, TMK_DATA rtSubAddr){return -1;}
inline void frtputflag_usb(TMK_DATA rtDir, TMK_DATA rtSubAddr, TMK_DATA rtFlag){}
inline TMK_DATA frtgetstate_usb(){return -1;}
inline TMK_DATA frtbusy_usb(){return -1;}
inline void frtlock_usb(TMK_DATA rtDir, TMK_DATA rtSubAddr){}
inline void frtunlock_usb(){}
inline TMK_DATA frtgetcmddata_usb(TMK_DATA rtBusCommand){return -1;}
inline void frtputcmddata_usb(TMK_DATA rtBusCommand, TMK_DATA rtData){}
inline int fmtreset_usb(){return -1;}
inline TMK_DATA fmtgetsw_usb(){return -1;}
inline TMK_DATA frtenable_usb(TMK_DATA rtEnable){return -1;}
inline int fmrtselected_usb(){return -1;}
inline TMK_DATA fmrtgetstate_usb(){return -1;}
inline void fmrtdefbrcsubaddr0_usb(){}
inline int fmrtreset_usb(){return -1;}
inline TMK_DATA ftmktimer_usb(TMK_DATA TimerCtrl){return -1;}
inline DWORD ftmkgettimer_usb(){return -1;}
inline DWORD ftmkgettimerl_usb(){return -1;}
inline DWORD fbcgetmsgtime_usb(){return -1;}
inline DWORD frtgetmsgtime_usb(){return -1;}
inline TMK_DATA ftmkgethwver_usb(){return -1;}
inline DWORD ftmkgetevtime_usb(){return -1;}
inline TMK_DATA ftmkswtimer_usb(TMK_DATA tmkTimerCtrl){return -1;}
inline DWORD ftmkgetswtimer_usb(){return -1;}
inline TMK_DATA ftmktimeout_usb(WORD tmkTimeOut){return -1;}
inline int fmrtdefbrcpage_usb(TMK_DATA mrtBrcPage){return -1;}
inline TMK_DATA fmrtgetbrcpage_usb(){return 0;}

inline DWORD fMonitorHwStart_usb(DWORD dwBufSize, HANDLE hEvent){return -1;}
inline DWORD fMonitorHwGetMessage_usb(WORD * Data, DWORD dwBufSize, BOOL FillFlag, DWORD * dwMsWritten){return -1;}
inline DWORD fMonitorHwStop_usb(void){return -1;}

inline unsigned int ftmkrawio_usb(unsigned int *buf_out, unsigned int *buf_in){return -1;}

/*extern int *ptmkError;*/
